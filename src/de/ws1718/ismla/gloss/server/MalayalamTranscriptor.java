...
import de.ws1718.ismla.gloss.server.translit.MalayalamScriptToAsciiISOTransliterator;
...
public class MalayalamTranscriptor {
	...
	private MalayalamScriptToAsciiISOTransliterator script2ascii;
	...
	public MalayalamTranscriptor(ServletContext servletContext) {
		...
		script2ascii = new MalayalamScriptToAsciiISOTransliterator(false, servletContext);
